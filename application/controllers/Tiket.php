...
class Tiket extends CI_Controller {
	...
	public function gettiket($value=''){
		...
		redirect($this->session->set_flashdata('message', 'swal("Cek", "Email kamu untuk melakukan pembayaran", "success");').
			'profile/tiketsaya/'.$this->session->userdata('kd_pelanggan'));
	}
