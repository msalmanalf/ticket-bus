...
class Bank extends CI_Controller {
	...
	public function tambahbank()
	{
		...
		if (!$this->upload->do_upload('userfile')){
			...
			$this->session->set_flashdata('message', 'swal("Berhasil", "Data Bank Tersimpan", "success");');
			redirect('adm/bank');
		}
	}
...
/* Location: ./application/controllers/adm/Bank.php */