  ...
  <?php $this->load->view('adm/include/base_nav'); ?>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><a href="<?= base_url('adm/order') ?>">Pending Order</a></div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="<?= base_url('adm/tiket') ?>">Total Tiket terjual</a></div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><a href="<?= base_url('adm/konfirmasi') ?>">List Konfirmasi</a></div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
            ...
            <!-- Pending Requests Card Example --/> hapus baris 105 klu mw pake
            <div class="col-xl-3 col-md-6 mb-4">
