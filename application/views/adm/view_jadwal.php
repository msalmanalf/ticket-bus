    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">             
            ...
            <a href="<?= base_url() ?>adm/jadwal/hapus/<?= $jadwal['kd_jadwal'] ?>" class="btn btn-danger">Hapus</a>
          </div>
      </div>
    </div>
  </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="<?php echo base_url('adm/jadwal/ubahtujuan') ?>" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-14">
                          <div class="row form-group">
                              <label for="" class="control-label">Bus</label>
                              <input type="text" class="form-control" id="tujuan" name="tujuan" value="<?php echo $jadwal['nama_bus']?>" >
                          </div>
                          <div class="row form-group">
                              <label for="" class="control-label">Asal</label>
                              <input type="text" class="form-control" id="asal" name="asal" value="<?php echo $asal['kota_tujuan']?>" >
                          </div>
                          <div class="row form-group">
                              <label for="" class="control-label">Tujuan</label>
                              <input type="text" class="form-control" id="tujuan" name="tujuan" value="<?php echo $jadwal['kota_tujuan']?>" >
                          </div>
                          <div class="row form-group">
                              <label for="" class="control-label">Jam Berangkat</label>
                              <input type="text" class="form-control" id="jamberangkat" name="jamberangkat" value="<?php echo $jadwal['jam_berangkat_jadwal']?>" >
                          </div>
                          <div class="row form-group">
                              <label for="" class="control-label">Jam Tiba</label>
                              <input type="text" class="form-control" id="jamtiba" name="jambtiba" value="<?php echo $jadwal['jam_tiba_jadwal']?>" >
                          </div>
                          <div class="row form-group">
                              <label for="" class="control-label">Harga Jadwal</label>
                              <input type="text" class="form-control" id="harga" name="harga" value="<?php echo $jadwal['harga_jadwal']?>" >
                          </div>
                      </div>
                    </div>
                  </div>
