    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">KODE Order [<?= $tiket[0]['kd_order']; ?>]  </h6>
        </div>
        <div class="card-body">
          <form action="<?= base_url().'adm/order/inserttiket' ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <label >Kode Tiket <b><?= $row['kd_tiket'] ?></b></label>
                  <p>Nama Pemesan <b><?= $row['nama_order']; ?></b></p>
                  <hr>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="umur_kursi[]>" value="<?= $row['umur_kursi_order'] ?> Tahun" readonly>
                    </div>
                  </div>
                  <div class="row form-group">
                ...
                <div class="col-sm-6">
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <a href="<?= base_url('adm/konfirmasi/viewkonfirmasi/'.$tiket[0]['kd_order']) ?>" class="btn btn-secondary">Lihat</a>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
              ...
              <hr><a class="btn btn-default float-left" href="<?= base_url().'adm/order' ?>"> Kembali</a>
              <?php if ($tiket[0]['status_order'] == '1') { ?>
                <button type="submit" class="btn btn-info float-right">Proses</button>
            <?php }else{ ?>
              <a class="btn btn-primary float-right" href="<?= base_url('assets/adm/upload/etiket/'.$row['kd_order'].'.pdf') ?>" target="pdf"> Cetak Eticket</a> 
                        <?php } ?>
            </div>
          </div>
        </form>
