    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">             
            ...
            <a href="<?= base_url() ?>adm/rute/hapus/<?= $rute['kd_tujuan'] ?>" class="btn btn-danger">Hapus</a>
          </div>
      </div>
    </div>
  </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="<?php echo base_url('adm/rute/ubahtujuan') ?>" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-14">
                          <div class="row form-group">
                              <label for="tujuan" class="control-label">Kota Tujuan</label>
                              <input type="text" class="form-control" id="tujuan" name="tujuan" value="<?php echo $rute['kota_tujuan']?>" >
                          </div>
                          <div class="row form-group">
                              <label for="terminal" class="control-label">Tujuan</label>
                              <input type="text" class="form-control" id="terminal" name="terminal" value="<?php echo $rute['terminal_tujuan']?>" >
                          </div>
                      </div>
                    </div>
                  </div>
