...
<body onload="window.print()">
  ...
  <div id="container">
    ...
    <div id="body">
        <ol type="1">
          <li>Tiket Tourismo Bus * HANYA agen tiket bus. Ini tidak mengoperasikan layanan bus
            ...
            operator.
            Saran Tiket Tourismo Bus kepada pelanggan adalah memilih operator bus yang mereka ketahui
          ...
          <li>Waktu keberangkatan yang disebutkan di tiket hanyalah waktu tentatif. Namun
           ...
           <li>Tanggung jawab Tiket Tourismo Bus meliputi:
            ...
            alasannya, Tiket Tourismo Bus akan mengembalikan jumlah diferensial kepada pelanggan setelah menjadi
        ...
        10,0%.</li>
        <li>Tanggung jawab Tiket Tourismo Bus TIDAK termasuk:
        ...
        tulis rincian kupon tunai Anda ke support@TiketTourismoBus.in
