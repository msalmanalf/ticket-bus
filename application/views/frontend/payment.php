			...
			<div class="container">
				<div class="row d-flex justify-content-center">
					...
					<div class="col-lg-8">
						...
						<div class="card">
							<div class="card-header" align="center">
								<i class="fa fa-ticket"></i> Proses Pembayaran Tiket
							</div>
							<div class="card-body" align="center">
								<h4>Selesaikan Pembayaran dengan segera !</h4><br>
								...
								<div class="offset-lg-1 col-lg-10 offset-sm-0 col-sm-12">
									<div class="row">
										...
										<div class="col-md-3 copy-link">
											<button onclick="myFunction()" class="btn">Salin NoRek</button>
										</div>
									</div>
								</div>
								<div class="col-12 medium-title regular-text mt-20">
									<h4><b> <p>Nominal</p></b></h4>
								</div>
								...
								<div class="col-14 mt-15 mb-15">
									...
									<div class="col-md-8 mt-sm-30">
										<h3 class="mb-20">Panduan Pembayaran ATM</h3>
										<div class="">
				...
				swal("Salin", "Nomor Rekening Tersalin", "info");
				}
				</script>
				<script>
